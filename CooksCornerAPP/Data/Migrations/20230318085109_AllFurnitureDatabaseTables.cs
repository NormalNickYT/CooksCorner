...
{
    public partial class AllFurnitureDatabaseTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalTime = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRecipesFavorites", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRecipesFavorites_RecipeId",
                table: "UserRecipesFavorites",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRecipesFavorites_UserId",
                table: "UserRecipesFavorites",
                column: "UserId");
        }
